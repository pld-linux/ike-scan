...
Summary(pl.UTF-8):   Wykrywanie i uzyskiwanie odcisków hostów IKE (serwerów VPN)
Name:		ike-scan
Version:	1.6
Release:	0.1
License:	GPL
...
ike-skan wykrywa hosty IKE, a ponadto może uzyskać ich odciski przy
użyciu techniki "retransmission backoff pattern".
